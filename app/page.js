...
// // import { MapPin, House, Search, ArrowRight, ChevronDown } from "lucide-react";
...
// //           />
// //           {/* THE OVERLAY: This now covers the very top of the screen too */}
...
// //           {/* Search Box Card - Clean Cream/White */}
...
// //                 <button className="w-full h-12 bg-[#2d5a43] text-white rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-[#244835] transition-all shadow-lg">
...
// //       {/* Rest of your home page content follows here */}
// //     </main>
// //   );
// // }
...
// export default function Home() {
//   const statsData = [
//     { label: "Properties Sold", value: "500+", delay: "0s" },
//     { label: "Years Experience", value: "15+", delay: "0.1s" },
//     { label: "Happy Families", value: "1000+", delay: "0.2s" },
//     { label: "Villages Covered", value: "50+", delay: "0.3s" },
//   ];
...
//             className="w-full h-full object-cover"
//           />
//           {/* THE OVERLAY: Matches your forest green theme */}
//           <div className="absolute inset-0 bg-[#2d5a43]/75 backdrop-blur-[1px]"></div>
//         </div>
...
//       {/* Stats Section - EXACT MATCH FOR CREAM/GREEN THEME */}
...
//       {/* Add your Featured Properties or other sections here */}
//     </main>
//   );
// }
...
//       {/* 1. HERO SECTION (Nav sits on top via absolute positioning in Navbar.jsx) */}
...
//             <h2 className="font-serif text-4xl md:text-5xl font-bold text-[#2d5a43] mb-4">Featured Properties</h2>
//             <p className="text-slate-500 text-lg">Handpicked properties for you</p>
//           </div>

//           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
//             {properties.map((property) => (
//               <div key={property.id} className="group bg-white rounded-2xl overflow-hidden shadow-lg border border-slate-100">
//                 <div className="relative aspect-[4/3] overflow-hidden">
//                   <img src={property.img} alt={property.title} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
//                   <div className="absolute top-3 left-3 px-3 py-1 rounded-full bg-[#2d5a43] text-white text-[10px] font-bold uppercase">{property.type}</div>
...
//                   <h3 className="font-serif font-bold text-xl text-slate-900 group-hover:text-[#2d5a43] transition-colors">{property.title}</h3>
...
//                     </div>
//                     <div className="text-xl font-black text-[#2d5a43]">{property.price}</div>
//                   </div>

//                   <div className="flex gap-2">
//                     <button className="flex-1 flex items-center justify-center gap-2 border border-slate-200 py-2.5 rounded-xl text-xs font-bold text-slate-700 hover:bg-slate-50 transition-all">
...
//             <Link href="/properties">
//               <button className="inline-flex items-center justify-center gap-2 bg-[#2d5a43] text-white px-10 h-14 rounded-2xl font-bold hover:shadow-xl transition-all">
...
//       {/* 4. WHY CHOOSE US TITLE (Matches bottom of your image) */}
//       <section className="py-20 bg-[#f1ede4]">
//         <div className="container mx-auto px-4 text-center">
//           <h2 className="font-serif text-4xl md:text-5xl font-bold text-[#2d5a43]">Why Choose Us</h2>
//           <div className="w-24 h-1 bg-[#2d5a43] mx-auto mt-4 rounded-full"></div>
//         </div>
//       </section>
//     </main>
//   );
...
//             className="w-full h-full object-cover"
//           />
//           {/* THE OVERLAY: Bleeds to the very top behind your transparent Navbar */}
//           <div className="absolute inset-0 bg-[#2d5a43]/75 backdrop-blur-[1px]"></div>
//         </div>
...
//           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
//             {properties.map((property) => (
//               <div key={property.id} className="group bg-white rounded-2xl overflow-hidden shadow-lg border border-slate-100 transition-all hover:shadow-2xl">
//                 <div className="relative aspect-[4/3] overflow-hidden">
//                   <img src={property.img} alt={property.title} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
//                   <div className="absolute top-3 left-3 px-3 py-1 rounded-full bg-[#2d5a43] text-white text-[10px] font-bold uppercase">{property.type}</div>
//                   <div className="absolute top-3 right-3 px-2 py-1 rounded-full bg-white/90 backdrop-blur-sm text-[10px] font-bold flex items-center gap-1 text-[#2d5a43]">
...
//       {/* 4. WHY CHOOSE US (EXACT MATCH TO YOUR SCREENSHOT) */}
...
//                 {/* Rounded Icon Box from Screenshot */}
